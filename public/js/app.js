...
__webpack_require__("./resources/assets/js/thunderlab/ajax.js");
__webpack_require__("./resources/assets/js/thunderlab/numberFormat.js");
// require ('./thunderlab/dataBox.js');

// call plugin
__webpack_require__("./resources/assets/js/plugins.js");
// module UI for use plugin jquery.inputmask
__webpack_require__("./resources/assets/js/plugins/jquery.inputmask/form-inputmask.js");
...
/***/ "./resources/assets/js/plugins/jquery.inputmask/form-inputmask.js":
...
window.formInputMask = {
	...
	yearBefore: function yearBefore() {
		var today = new Date();
		var year = today.getFullYear();

		var yearBefore = new Inputmask({
			alias: 'dd/mm/yyyy',
			yearrange: { minyear: year - 20, maxyear: year }
		});
		var selector = $('.mask-year-before-now');
		yearBefore.mask(selector);
	},
	yearAfter: function yearAfter() {
		var today = new Date();
		var year = today.getFullYear();

		var yearAfter = new Inputmask({
			alias: 'dd/mm/yyyy',
			yearrange: { minyear: year - 30, maxyear: year + 30 }
		});
		var selector = $('.mask-year-after-now');
...
/***/ "./resources/assets/js/thunderlab/ajax.js":
/***/ (function(module, exports) {
...
/***/ "./resources/assets/js/thunderlab/numberFormat.js":
/***/ (function(module, exports) {
