								...
								<tbody>
									...
									<tfoot>
										...
										<tr>
											...
											<td class="text-right">{{$idr->formatMoneyTo($total_money)}}</td>
										...
										<tr>
											...
											<td colspan="2" rowspan="2"><i>Terbilang : {{ucwords($idr->terbilang($total_money + $total_money_yesterday ))}} Rupiah</i></td>
										</tr>
									</tfoot>
								</tbody>
							</table>
