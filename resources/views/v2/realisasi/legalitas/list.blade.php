...
<ul class="nav nav-tabs" role="tablist">
	...
	<li class="nav-item">
		<a class="nav-link" data-toggle="tab" href="#bukti-pencairan" role="tab">
			Bukti Pencairan
		</a>
	</li>
</ul>
...
<div class="tab-content">
	<div class="tab-pane" id="legalitas-realisasi" role="tabpanel">
		...
		@if(str_is($permohonan['status_terakhir']['progress'], 'perlu') || str_is($permohonan['status_terakhir']['status'], 'putusan'))
			<div class="row">
				<div class="col">
				...
				@if($vc=='ada')
					<div class="row">
						<div class="col-12 pt-1 pb-1">
							...
							CETAK {{strtoupper(str_replace('_', ' ', $kc))}}
							</a><br/>
						</div>
					</div>
				@endif
	...
	<div class="tab-pane" id="bukti-pencairan" role="tabpanel">
		<div class="clearfix">&nbsp;</div>
