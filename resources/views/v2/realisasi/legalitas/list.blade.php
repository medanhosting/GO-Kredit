...
<ul class="nav nav-tabs underline" role="tablist">
	<li class="nav-item">
		<a class="nav-link active" data-toggle="tab" href="#bukti-pencairan" role="tab">
			Bukti Pencairan
		</a>
	</li>
	<li class="nav-item">
...
<div class="tab-content">
	<div class="tab-pane fade show active" id="bukti-pencairan" role="tabpanel">
		<div class="clearfix">&nbsp;</div>
		@include('v2.realisasi.bukti_pencairan')
	</div>
	<div class="tab-pane fade" id="legalitas-realisasi" role="tabpanel">
		<div class="clearfix">&nbsp;</div>
		@if(str_is($putusan['pengajuan']['status_realisasi']['progress'], 'perlu') || str_is($putusan['pengajuan']['status_realisasi']['status'], 'putusan'))
			<div class="row">
				<div class="col">
