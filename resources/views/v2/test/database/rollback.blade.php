	...
	<div class="row mt-3">
		...
		<div class="col">
			@component('bootstrap.card')
				@slot('header')
					<h5 class="py-2 pl-3 mb-0 float-left">&nbsp;&nbsp;ROLLBACK TRANSAKSI</h5>
				@endslot

				<div class="card-body">
					<form action="{{route('db.rollback', ['kantor_aktif_id' => $kantor_aktif_id])}}" method="GET">
						<div class="row">
							<!-- CARI BERDASARKAN DOKUMEN -->
							<div class="col-sm-4">
								<label>Rollback Transaksi Tanggal</label>
								<div class="form-row">
									<div class="col">
