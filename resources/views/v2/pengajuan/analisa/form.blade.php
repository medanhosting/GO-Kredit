...
<div class="tab-content">
	...
	<div class="tab-pane fade" id="fanalisa" role="tabpanel">
		...
		{!! Form::open(['url' => route('pengajuan.update', ['id' => $permohonan['id'], 'kantor_aktif_id' => $kantor_aktif_id]), 'method' => 'PATCH']) !!}
			<div class="row">
				<div class="col">
					{!! Form::vText('Tanggal Analisa', 'tanggal', $analisa['tanggal'], ['class' => 'form-control mask-date inline-edit text-info pb-1 border-input w-25', 'placeholder' => 'dd/mm/yyyy hh:mm'], true) !!}
				</div>
			</div>
			<div class="row">
				<div class="col">
			...
			<div class="row">
				<div class="col">
					{!! Form::vText('Jangka Waktu', 'jangka_waktu', $analisa['jangka_waktu'], ['class' => 'form-control inline-edit border-input text-info pb-1', 'placeholder' => '12'], true, null, null, 'Bulan',  ['class_input_group' => 'w-25', 'class_input_group_append' => 'border-0 bg-white']) !!}
				</div>
			</div>
			<div class="row">
				<div class="col">
