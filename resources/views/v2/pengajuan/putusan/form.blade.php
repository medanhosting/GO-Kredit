...
<div class="tab-content">
	<div class="tab-pane fade show active" id="form-putusan" role="tabpanel">
		...
		{!! Form::open(['url' => route('pengajuan.update', ['id' => $permohonan['id'], 'kantor_aktif_id' => $kantor_aktif_id]), 'method' => 'PATCH']) !!}
			<div class="row">
				<div class="col">
					{!! Form::vText('Tanggal Putusan', 'tanggal', $putusan['tanggal'], ['class' => 'form-control mask-date inline-edit text-info pb-1 border-input w-25', 'placeholder' => 'dd/mm/yyyy hh:mm'], true) !!}
				</div>
			</div>
			<div class="row">
				<div class="col">
