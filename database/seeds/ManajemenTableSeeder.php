...
class ManajemenTableSeeder extends Seeder
{
	...
	public function run()
	{
		...
		//BASIC PENEMPATAN
		PenempatanKaryawan::create(['kantor_id' => Kantor::orderby('created_at', 'asc')->first()['id'], 'orang_id' => Orang::orderby('created_at', 'asc')->first()['id'], 'role' => 'komisaris', 'scopes' => ['pengajuan','permohonan', 'survei', 'analisa', 'putusan', 'setujui', 'tolak', 'realisasi', 'expired', 'kantor', 'karyawan'], 'policies' => '', 'tanggal_masuk' => Carbon::now()->format('d/m/Y H:i')]);
		
		PenempatanKaryawan::create(['kantor_id' => Kantor::orderby('created_at', 'asc')->skip(1)->first()['id'], 'orang_id' => Orang::orderby('created_at', 'asc')->first()['id'], 'role' => 'komisaris', 'scopes' => ['pengajuan','permohonan', 'survei', 'analisa', 'putusan', 'setujui', 'tolak', 'realisasi', 'expired', 'kantor', 'karyawan'], 'policies' => ['putusan' => ['max:10000000']], 'tanggal_masuk' => Carbon::now()->format('d/m/Y H:i')]);
